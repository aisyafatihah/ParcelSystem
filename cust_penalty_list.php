  ...
  <div class="sidebar">
    ...
    <div class="sidebar-menu">
      ...
      <ul>
        ...
        <li>
          <a class="active" href="cust_penalty_list.php"><span class='bx bx-money-withdraw'></span><span>Penalty List</span></a>
        </li>
        <li>
      ...
      <tbody>
         <?php
          ...
          if($userType == "B"){
               ...
               $sql = "SELECT * FROM parcel, customer_student WHERE CONCAT(studentID) LIKE '%$user_ID%' AND CONCAT(customer_stud_ID) LIKE '%$user_ID%' AND DATEDIFF(CURRENT_DATE,dateAdd) > 7";
             ...
             <?php 
               ...
               <?php
                  ...
                  if($userType == "0"){
                    ...
                    $sql = "SELECT * FROM parcel, customer_staff WHERE CONCAT(staffID) LIKE '%$user_ID%' AND CONCAT(customer_staff_ID) LIKE '%$user_ID%' AND DATEDIFF(CURRENT_DATE,dateAdd) > 7";
                    $result = mysqli_query($conn, $sql);
