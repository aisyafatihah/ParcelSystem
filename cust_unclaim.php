  ...
  <div class="sidebar">
    ...
    <div class="sidebar-menu">
      ...
      <ul>
        ...
        <li>
          <a class="active"  href="cust_unclaim.php"><span class='bx bxs-package'></span><span>Unclaimed Parcel</span></a>
        </li>
        <li>
...
<div class="user-wrapper">
  ...
  <div><?php echo '<h4>'.$salut. " " .$user_name.'</h4>'; ?>
      ...
      <tbody>
         <?php
          ...
          if($userType == "B"){
               ...
               $sql = "SELECT * FROM parcel, customer_student WHERE CONCAT(studentID) LIKE '%$user_ID%' AND CONCAT(customer_stud_ID) LIKE '%$user_ID%'";
             ...
             <?php 
               ...
               <?php
                  ...
                  if($userType == "0"){
                    ...
                    $sql = "SELECT * FROM parcel, customer_staff WHERE CONCAT(staffID) LIKE '%$user_ID%' AND CONCAT(customer_staff_ID) LIKE '%$user_ID%'";
                    $result = mysqli_query($conn, $sql);
