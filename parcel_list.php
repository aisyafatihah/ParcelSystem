  ...
  <div class="sidebar">
    ...
    <div class="sidebar-menu">
      ...
      <ul>
        ...
        <li>
          <a class="active" href="parcel_list.php"><span class='bx bxs-package'></span><span>Unclaimed Parcel</span></a>
        </li>
        <li>
  ...
  <table width=100%>
      ...
      <?php
              ...
              //search user from student table
                  if($userType == "B"){
                  $sql = "SELECT * FROM parcel, customer_student WHERE CONCAT(studentID) LIKE '$filtervalues' AND CONCAT(customer_stud_ID) LIKE '%$filtervalues%' ";
                ...
                ?>
                        <tr>
                          ...
                          <td><?= $items['dateAdd']; ?></td>
                          <td><a href="del.php?delete=<?php echo $items['trackingNo']; ?>">Claim</a></td>
                        </tr>
              <?php
                      }
                    ...
                    $sql = "SELECT * FROM parcel, customer_staff WHERE CONCAT(staffID) LIKE '$filtervalues' AND CONCAT(customer_staff_ID) LIKE '%$filtervalues%'";
                    $result = mysqli_query($conn, $sql);
...
<script src="dataTables.bootstrap5.min" crossorigin="anonymous"></script>
